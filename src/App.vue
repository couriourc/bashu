        ...
        <el-row align="middle" justify="center" type="flex">
          <el-col :span="10" align="left">
            <el-row style="margin-top: 7px">
              <el-col :span="10">
                <el-link :underline="false" style="color:#fdfff4 ;"> 官网首页</el-link>
              </el-col>
            </el-row>
            <el-row style="margin-top: 7px">
              <el-col :span="10" align="left">
                <el-link :underline="false" style="color: #fdfff4;"> 关于我们</el-link>
              </el-col>
            </el-row>
            <el-row style="margin-top: 7px">
              <el-col :span="10" align="left">
                <el-link :underline="false" style="color: #fdfff4;"> 中国非物质文化遗产网</el-link>
              </el-col>
            </el-row>
            <el-row style="margin-top: 7px; margin-bottom: 7px">
              <el-col :span="10" align="left">
                <el-link :underline="false" style="color: #fdfff4;"> 中国·四川非物质文化遗产</el-link>
              </el-col>
            </el-row>
            <el-row style="margin-top: 7px; margin-bottom: 7px">
              <el-col :span="10">
                <el-link :underline="false" style="color: #fdfff4;"> 重庆市文化研究院</el-link>
              </el-col>
